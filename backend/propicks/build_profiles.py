...
def build_daily_team_profiles(profile_date: date) -> int:
    ...
    for t in teams_today:
        ...
        for window, n in WINDOWS.items():
            ...
            rows.append({
                'profile_date': profile_date, 'team_id': team_id, 'opponent_team_id': t['opponent_team_id'], 'game_pk': t['game_pk'], 'home_away': t['home_away'], 'window': window, 'games_sample': gs,
